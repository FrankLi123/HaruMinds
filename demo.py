...
impath = '/Users/zongchenli/Documents/Side_Project/Project/online-chat-project/gif/'
...
window.wm_attributes('-transparent')
label.pack()
...
# window.bind("<ButtonRelease-1>", on_drag_release)
window.mainloop()
